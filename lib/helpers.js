 ...
 * @returns {Object}
 */
TALCH.validate.password = function(password) {
  var message = '';
 ...
 * @returns {Object}
 */
TALCH.validate.email = function(email) {
  var test = /^[A-Z0-9'.1234z_%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(email);
  return {
    isValid: function() {
