...
var schema = new SimpleSchema({
  ...
  // TODO: Root node only, add custom validation
  description: {
    type: String,
    label: "Description",
    max: 4000,
  ...
  elements: {
    type: Object,
    label: "Graph nodes and edges used to initialize cytoscape instance",
    optional: true,
    blackbox: true
  },
  // TODO: Children only, add custom validation
  roots: {
    type: [String],
    optional: true
  }
...
// --------------------------------------------------------------
// TODO: Move everything bellow to node helpers
// --------------------------------------------------------------
